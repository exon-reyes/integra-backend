...
import integra.asistencia.service.kiosco.KioscoService;
...
public class KioscoController {
    ...
    private final KioscoService commandService;
    ...
    public ResponseEntity<ResponseData<Void>> actualizarTiempoEspera(@RequestParam Integer tiempoEspera) {
        ...
        return ResponseEntity.ok(ResponseData.of(true, "Tiempo de espera actualizado correctamente"));
    }

    @GetMapping("/tiempo-captura")
    public ResponseEntity<ResponseData<Integer>> obtenerTiempoCaptura() {
        return ResponseEntity.ok(ResponseData.of(queryService.obtenerTiempoCaptura(), "Tiempo de espera"));
    }
}
