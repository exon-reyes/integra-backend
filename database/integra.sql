/*
 ...
 Source Server Version : 110806 (11.8.6-MariaDB)
 Source Host           : localhost:3306
 Source Schema         : integra
...
-- ----------------------------
-- Table structure for descansos_empleado
-- ----------------------------
...
CREATE TABLE `empleado`  (
  ...
  `descansos_configurados` tinyint(1) NULL DEFAULT 0 COMMENT 'Indica si el empleado ha configurado sus días de descanso',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_spanish_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_spanish_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for vacaciones_auditoria
-- ----------------------------
...
-- ----------------------------
DROP TABLE IF EXISTS `vinculacion_gestion`;
CREATE TABLE `vinculacion_gestion`  (
  ...
  `activo` tinyint(1) NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_vinculo_unico`(`empleado_id` ASC, `tipo_proceso_id` ASC, `nivel_autoridad` ASC) USING BTREE,
  INDEX `fk_vinculo_gestor`(`gestor_id` ASC) USING BTREE,
  INDEX `fk_vinculo_tipo_proceso`(`tipo_proceso_id` ASC) USING BTREE,
  INDEX `idx_busqueda_vinculo`(`empleado_id` ASC, `tipo_proceso_id` ASC) USING BTREE,
  CONSTRAINT `fk_vinculo_empleado` FOREIGN KEY (`empleado_id`) REFERENCES `empleado` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
